...
<h2 class="text-xl font-bold mb-6 text-pink-500 text-center">Galeri Foto</h2>
...
echo "<div class='p-4'>";
echo "<h3 class='text-lg font-semibold text-pink-400'>" . 
...
?>
 ...
 <!-- Footer -->
<footer class="bg-pink-500 text-pink-300 text-center py-4 mt-10">
