...
$data['id_gallery']; ?>">
<div>
<label for="judul" class="block text-sm font-medium text-pink-600 
...
<div>
<label class="block text-sm font-medium text-pink-700 mb-1">Gambar 
Saat Ini</label>
<img src="../images/<?php echo $data['foto']; ?>" class="h-40 
rounded shadow mb-3" alt="Foto Lama">
</div>
<div>
<label for="foto" class="block text-sm font-medium text-pink-600 
mb-1">Ganti Gambar (Opsional)</label>
<input type="file" id="foto" name="foto" accept="image/*"
class="block w-full text-sm text-pink-600 file:mr-4 file:py-2 
file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold 
file:bg-pink-300 file:text-pink-700 hover:file:bg-pink-400">
</div>
<div class="flex justify-end space-x-4">
<button type="submit"
class="bg-pink-400 text-white px-4 py-2 rounded hover:bg-pink-
