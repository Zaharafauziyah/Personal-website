...
<li><a href="about.php" class="block font-semibold text-pink-400">About</a></li>
<li>
...
focus:border-pink-500"><?php echo htmlspecialchars($data['about']); 
?></textarea>
</div>
<div class="flex justify-end space-x-4">
<button type="submit"
class="bg-pink-700 text-white px-4 py-2 rounded hover:bg-pink-400 transition">Update</button>
<a href="about.php"
