...
<h2 class="text-xl font-semibold text-pink-900 mb-4 textcenter">MENU</h2>
...
<li><a href="data_gallery.php" class="block hover: text-pink-600">Kelola Gallery</a></li>
<li><a href="about.php" class="block font-semibold text-pink-600">About</a></li>
<li>
...
<h2 class="text-xl font-bold text-pink-600">Tentang Saya</h2>
